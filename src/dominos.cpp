...
float xpos = 30;///the x-ordinate of engine center. Center refers to bottom center of engine
	 ...
	 dominos_t::dominos_t()
	 {
		...
		//=========================================================================================================================
	 	...
	 	float trainHeight = 15, trainWidth = 30;
	 	{
	 		...
	 		b2BodyDef myBodyDef;
					...
					myBodyDef.position.Set(-50, trainHeight + wheelRadius*0.6);
		...
		///Piston rod of engine
		      ...
		      //The open box
					...
					b2PolygonShape bs2;
					bs2.SetAsBox(5*scale,0.25*scale, b2Vec2(-5.15*scale,1.75*scale), 0);
					fd2->shape = &bs2;
...

				{
					...
					prismaticJointDef.localAnchorA.Set(0,0.5*scale);
					prismaticJointDef.localAnchorB.Set(0,0.5*scale);
		...
		///The upper cover of engine
				...
				// ///Distanceing upperCover and engineExt
				// {
				// 	b2DistanceJointDef jointDef;
				// 	jointDef.bodyA = engineExt;
				// 	jointDef.bodyB = upperCover;
				// 	jointDef.collideConnected = false;
				// 	// jointDef.localAnchorA = b2Vec2(0,0);
				// 	// jointDef.localAnchorB = b2Vec2(0, -trainHeight+0.4*wheelRadius);
		...
		///The valve rod of engine    
		      ...
		      //The open box
				...
				// 		prismaticJointDef.localAnchorA.Set(0,5*scale);
				// 		prismaticJointDef.localAnchorB.Set(0,0*scale);
